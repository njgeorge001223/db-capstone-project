...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ 'ddd3eb90-1e39-11f1-9a95-9216b54a54c4:1-55';
...
CREATE TABLE `bookings` (
  ...
  KEY `fk_customers_idx` (`customer_id`),
...
CREATE TABLE `order_delivery` (
  ...
  CONSTRAINT `fk_order_delivery_orders1` FOREIGN KEY (`order_id`) REFERENCES `orders` (`order_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `fk_orders_bookings1` FOREIGN KEY (`booking_id`) REFERENCES `bookings` (`booking_id`),
...
-- Dump completed on 2026-03-18 12:38:27
